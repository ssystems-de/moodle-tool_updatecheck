...
abstract class base extends check {
    ...
    protected function format_details(array $lines): string {
        ...
        if ($this->cli) {
            ...
            // just be clutter. That's why it is hidden there: Visually with the visually-hidden class and additionally
            ...
            $separator = \html_writer::span($separator, 'visually-hidden', ['aria-hidden' => 'true']);
        }
